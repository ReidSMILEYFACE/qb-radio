...
RegisterKeyMapping('openradio', 'Open Radio', 'keyboard', 'I')
RegisterKeyMapping('Volup1', 'Turn Radio Up', 'keyboard', 'PAGEUP')
RegisterKeyMapping('Radiovoldown', 'Turn Radio Down', 'keyboard', 'PAGEDOWN')
